...
constexpr float START_THRESHOLD            = 190.0f;
constexpr float STOP_THRESHOLD             = 150.0f;

constexpr unsigned long START_CONFIRM_MS   = 30000UL; // 25s
constexpr unsigned long STOP_CONFIRM_MS    = 30000UL;  // 25s
